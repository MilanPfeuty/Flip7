...
afficher_stats.o: afficher_stats.c
	gcc -c afficher_stats.c
...
exec: main.o affiche_joueur.o afficher_stats.o calcul_score.o carte_piochee.o choix_joueur.o creer_pioche.o deroulement_partie.o debut.o tour_de_joueur.o sauvegarde_joueurs.o outils.o
	gcc main.o affiche_joueur.o afficher_stats.o calcul_score.o carte_piochee.o choix_joueur.o creer_pioche.o deroulement_partie.o debut.o tour_de_joueur.o sauvegarde_joueurs.o outils.o -o Flip7
